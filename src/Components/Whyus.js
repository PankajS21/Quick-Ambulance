...
export default function Whyus() {
  return (  
    <div className="container-fluid" style={{backgroundColor:"rgb(41, 128, 185)",width:"100%"}}>
      <br/>
  ...
  <div className="row">
    ...
    <h5 className="card-title" style={{color:"rgb(41, 128, 185)"}}><b>SaaS Model</b></h5><hr/>
    ...
    <a href="/" className="btn btn-primary">Enquire Now</a>
      ...
      <div className="col">
    <div className="card" style={{width: "20rem"}}>
        <img src={require("./loc.png")} alt="error" style={{height:"10rem",backgroundColor:"rgb(41, 128, 185)"}}></img><br/>  <div className="card-body">
    <h5 className="card-title" style={{color:"rgb(41, 128, 185)"}}><b>GPS Tracking Enabled</b></h5><hr/>
    ...
    <h5 className="card-title" style={{color:"rgb(41, 128, 185)"}}><b>Leased Ambulance Model</b></h5><hr/>
